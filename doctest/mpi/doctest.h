...
#include "doctest/mpi/reporter.h"
...
#define DOCTEST_CREATE_MPI_TEST_CASE(name,nb_procs,func) \
  void func([[maybe_unused]] int test_rank, [[maybe_unused]] int test_nb_procs, [[maybe_unused]] MPI_Comm test_comm, std::integral_constant<int,nb_procs>); \
  TEST_CASE(name * doctest::description("MPI_TEST_CASE")) { \
    doctest::execute_mpi_test_case<nb_procs>(func); \
  } \
  void func([[maybe_unused]] int test_rank, [[maybe_unused]] int test_nb_procs, [[maybe_unused]] MPI_Comm test_comm, std::integral_constant<int,nb_procs> test_nb_procs_as_int_constant)
